...
@Injectable()
export class LoansForFedsStepsService {
  public Login = '0';
  public PersonalInformation = '1';
  public LoanTerms = '02.1';
  public ArgyleIntegration = '02.2';
  public AtomicIntegration = '02';
  public BankSelection = '03';
  public VerifyPhoneNumber = '04';
  public BankInformation = '04.1';
  public DebitCard = '3';
  public Processing = '4';
